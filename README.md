...
Minimal-but-real DS-STAR-style iterative data-science agent with a pluggable LLM adapter system and a CLI.
...
- `round_XX_prompt.txt`: prompt per round (currently the coder prompt)
